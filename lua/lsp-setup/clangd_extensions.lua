-- Copy from: https://github.com/p00f/clangd_extensions.nvim/blob/453b5d8fef67ec62ed184c035a374d1016a395bd/lua/clangd_extensions/init.lua
-- MIT License, Copyright (c) 2022 Chinmay Dalal
